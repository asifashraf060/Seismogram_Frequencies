...
def spectrogram(time,data,dt,period_lims,Ntime_bins = 20000, period_bins = None, 
                Nperiod_bins = 300, Nimfs = 20, return_imfs = True):
    """
    ...
    emd = EMD(std_thr = .0000001, range_thr = .0000001, total_power_thr = 0.01, savr_thr = 0.001, DTYPE=np.float16, str = 'cubic', extrema_detection = 'parabol')
    emd.FIXE_H = 10000000000000
    imfs = emd(data, time)
